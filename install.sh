...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/nitinkunte/dotfiles/master/install.sh)"
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/nitinkunte/dotfiles/master/tools/install.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.com/nitinkunte/dotfiles/master/tools/install.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.githubusercontent.com/nitinkunte/dotfiles/tools/install.sh
#   sh install.sh
#
...
# or:
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/nitinkunte/dotfiles/master/tools/install.sh)" "" --keep-zshrc
#
